...
/**
 * Esta clase se utiliza para guardar y leer un ArrayList de Strings hacia
 * y desde el disco en la ruta C:/MisFicheros  El ArrayList no debe contener 
 * caracteres "#" pues este se utiliza como separador de elementos del Array.
 * Si la carpeta C:/MisFicheros no existe, debe crearla con los permisos 
 * pertinentes.
 * @author Enzo
 */
...
//SETTER
    private static void guardar(String nombre, String data){ 
    ...
    //GETTER
    private static String cargar(String nombre){
    ...
    private static String empaquetador(ArrayList<String> empa, String separador){
    ...
    private static ArrayList<String> desempaquetador(
